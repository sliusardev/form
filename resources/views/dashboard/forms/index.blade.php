    ...
    <div class="max-w-full mx-auto bg-white p-4 rounded-lg shadow-md">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
            ...
            @foreach($forms as $form)
                <div class="bg-white rounded-lg shadow p-5 border border-gray-200 hover:shadow-lg transition-shadow duration-200">

                    <div class="flex justify-between items-center mb-4">
                        <h3 class="text-lg font-semibold text-gray-800">#{{ $form->id }}</h3>
                        <span class="px-2 py-1 text-xs rounded-full {{ $form->is_enabled === true ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800' }}">

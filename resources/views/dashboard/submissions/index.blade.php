    ...
    <div class="max-w-full mx-auto bg-white p-4 rounded-lg shadow-md">
        <div class="flex flex-wrap justify-center lg:justify-between items-center mb-6">
            ...
            <div class="flex space-x-2">
                ...
                <a href="{{ route('submissions.index', ['view' => 'cards', 'form_id' => request('form_id')]) }}" class="px-4 py-2 rounded-md {{ request('view') === 'cards' ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-700 hover:bg-gray-300' }}">
                ...
                <a href="{{ route('submissions.index', ['view' => 'table', 'form_id' => request('form_id')]) }}" class="px-4 py-2 rounded-md {{ request('view', 'table') === 'table' ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-700 hover:bg-gray-300' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 inline-block" fill="none" viewBox="0 0 24 24" stroke="currentColor">
